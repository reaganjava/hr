...
<div class="about-content">
	<div class="about-left">
    	<div class="about-left-top"><img src="<%=request.getContextPath()%>/images/about-flsm.png" width="152" height="54" alt="法律声明"/></div>
        <div class="about-nav">
        	<ul>
            	<li class="about-nav-on"><a href="<%=request.getContextPath()%>/about.jsp">关于我们</a></li>
                <li class="about-nav-out"><a href="<%=request.getContextPath()%>/legal-notices.jsp">法律声明</a></li>
    ...
    <div class="about-right">
    	<div class="about-right-title">法律声明</div>
