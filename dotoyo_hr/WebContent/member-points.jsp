...
<div class="about-content">
	<div class="about-left">
    	<div class="about-left-top"><img src="<%=request.getContextPath()%>/images/about-hyjf.png" width="152" height="54" alt="会员积分"/></div>
        <div class="about-nav">
        	<ul>
                ...
                <li class="about-nav-out"><a href="<%=request.getContextPath()%>/member-points.jsp">会员积分</a></li>
            </ul>
        </div>
    </div>
    <div class="about-right">
    	<div class="about-right-title">会员积分</div>
