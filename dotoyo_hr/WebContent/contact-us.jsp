...
<div class="about-content">
	<div class="about-left">
    	<div class="about-left-top"><img src="<%=request.getContextPath()%>/images/about-lxwm.png" width="152" height="54" alt="联系我们"/></div>
        <div class="about-nav">
        	<ul>
                ...
                <li class="about-nav-out"><a href="<%=request.getContextPath()%>/contact-us.jsp">联系我们</a></li>
