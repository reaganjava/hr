...
<div class="banner-box">
	<div class="banner"><img src="<%=request.getContextPath()%>/images/about-banner.png" width="980" height="230" /></div>
</div>
<!--以上为头部分-->
<!--中间部分-->
<div class="about-content">
	<div class="about-left">
    	<div class="about-left-top"><img src="<%=request.getContextPath()%>/images/about-wszf.png" width="152" height="54" alt="网上支付"/></div>
        <div class="about-nav">
        	<ul>
            	<li class="about-nav-on"><a href="<%=request.getContextPath()%>/about.jsp">关于我们</a></li>
                ...
                <li class="about-nav-out"><a href="<%=request.getContextPath()%>/online-payment.jsp">网上支付</a></li>
                <li class="about-nav-on"><a href="<%=request.getContextPath()%>/member-points.jsp">会员积分</a></li>
            </ul>
        </div>
    </div>
    <div class="about-right">
    	<div class="about-right-title">网上支付</div>
