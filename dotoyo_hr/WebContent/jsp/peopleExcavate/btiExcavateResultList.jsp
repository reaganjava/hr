...
<s:form  id="pageFrom" name="pageFrom" method="POST" action="peopleExcavateAction!btiTalentSearch.action" namespace="/peopleExcavate">
...
<s:iterator value="excavateResultList">
	...
	<div class="rcss-p" style="display:none">
    	...
    	<div class="rcss-botton">
    		<a href="javascript:sendInterviewNotice(<s:property value="userId"/>)"><img src="<%=request.getContextPath()%>/images/excavate-search-botton1.gif" width="68" height="24" alt="邀请面试" onclick="return sendInterviewNotice(<s:property value="userId"/>);"/></a>
