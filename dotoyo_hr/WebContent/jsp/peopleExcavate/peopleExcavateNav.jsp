...
<div class="nav">
	<ul>
        ...
        <li id="menu04" class="nav-out" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/peopleExcavate/">人才挖掘</a></li>
