...
<body>
	...
	<!--中间部分-->
	<s:form name="submitJobInfo" id="submitJobInfo" method="post" action="applyJobCenter!submitApplyJobInfo.action" theme="simple" disabled="true">
		...
		<div class="jobs-box" align="center">
		         ...
		         <div class="jobs-select-div">
		              <ul>
		                  ...
		                  <s:iterator id="jobTypeList" value="jobTypeList" status="index">
		                  	<li>
		                  		<input <s:if test="#index.index==0"> checked="checked" </s:if>  id="<s:property value="code"/>" name="applyJobInfoDto.jobTypeCode" type="radio" value="<s:property value="code"/>" class="validate[required]"/>&nbsp;&nbsp;<label for="<s:property value="code"/>"><s:property value="name"/>&nbsp;&nbsp;&nbsp;</label>
		                  	</li>
		                  </s:iterator>
		              </ul>
		         </div>
		    ...
		    <div class="jobs-botton">
		        ...
		        <a href="javascript:closeApplyJobWindow()"><img src="<%=path%>/images/jobs-gb.png" width="83" height="32" alt="关闭"/></a>
		    </div>
