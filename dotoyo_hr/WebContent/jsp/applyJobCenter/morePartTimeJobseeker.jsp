...
<!--中间部分-->
       ...
       <div class="guwen-more">
       		<div class="jobs-title"><strong>兼职列表</strong></div>
            <div class="people-text2 people-text-bg3">
                <ul>
         ...
         <s:iterator value="partTimeList" status="index">
     ...
     <s:form  id="pageFrom" name="pageFrom" method="POST" action="applyJobCenter!morePartTimeJobseeker.action">
       <div class="qx">
