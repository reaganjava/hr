...
<!--中间部分-->
        ...
        <div class="guwen-more">
        	<div class="jobs-title"><strong>全职列表</strong></div>
            <div class="people-text2 people-text-bg2">
                <ul>
         ...
         <s:iterator value="fullTimeList" status="index">
   ...
   <s:form  id="pageFrom" name="pageFrom" method="POST" action="applyJobCenter!moreFullTimeJobseeker.action">
       <div class="qx">
