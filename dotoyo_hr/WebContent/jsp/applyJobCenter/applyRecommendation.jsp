...
<!--中间部分-->
<s:form name="submitRecommendationForm" id="submitRecommendationForm" method="post" action="applyJobCenter!submitRecommendationInfo.action" theme="simple">
<input id="submitRecommendationFormFlag" type="hidden" value="0"/>
<div class="jobs-box" align="center">
  <div class="jobs-title"><strong>成为线下推荐对象</strong></div>
    <div class="jobs-select">
         ...
         <div class="jobs-select-div">
              <ul>
                  ...
                  <li class="jobs6">
                  <input id="expectedPosition" name="recommendationDto.expectedPosition" type="text" size="50" maxlength="50" class="validate[required]"/>
                  </li>
              </ul>
         </div>
         <div class="jobs-select-div">
         ...
         <div class="jobs-select-div">
              <ul>
                  ...
                  <s:iterator id="jobTypeList" value="jobTypeList" status="index">
                  	<li><input <s:if test="#index.index==0">checked="checked"</s:if> id="<s:property value="code"/>" name="recommendationDto.jobTypeCode" type="radio" value="<s:property value="code"/>" class="validate[required]"/>&nbsp;&nbsp;<label for="<s:property value="code"/>"><s:property value="name"/>&nbsp;&nbsp;&nbsp;</label></li>
                  </s:iterator>
              </ul>
         </div>
         <div class="jobs-select-div">
              <ul>
                  ...
                  <li><input checked="checked" id="isAdvisor_Y" name="recommendationDto.isAdvisor" type="radio" value="Y" class="validate[required]"/>&nbsp;&nbsp;<label for="isAdvisor_Y">是</label></li>
                  <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="isAdvisor_N" name="recommendationDto.isAdvisor" type="radio" value="N" class="validate[required]"/>&nbsp;&nbsp;<label for="isAdvisor_N">否</label></li>
              </ul>
         </div>
         <div class="jobs-select-div">
              <ul>
                  <li class="jobs0">&nbsp;</li>
                  <li><input id="isApplyJob" name="isApplyJob" type="checkbox" value="Y" />&nbsp;&nbsp;<label for="isApplyJob">同时发布线上求职信息</label></li>
              </ul>
         </div>
    </div>
    <div class="jobs-botton">
    	<a href="javascript:void(0)" onclick="return submitApplyRecommendation();"><img src="<%=path%>/images/jobs-tj.png" width="83" height="32" alt="提交"/></a>
        <a href="javascript:document.submitRecommendationForm.reset()"><img src="<%=path%>/images/jobs-cz.png" width="83" height="32" alt="重置"/></a>
        <a href="javascript:window.clickClose()"><img src="<%=path%>/images/jobs-gb.png" width="83" height="32" alt="关闭"/></a>
    </div>
    <div class="jobs-wenxin-box">
    	<div class="jobs-wenxin">
            ...
            <div class="jobs-wenxin-right">
           		<p class="jobs-wenxin1">您发布的招聘信息需要建筑猎头人才网审核通过后，求职者才能搜索到。审核时间间隔一般在2小时左右，节假日除外。如需立即审核，您可致电0755－33396388或联系您你的客户服务专员。</p>
