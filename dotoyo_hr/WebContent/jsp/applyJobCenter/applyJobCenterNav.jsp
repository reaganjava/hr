...
<div class="nav">
	<ul>
        ...
        <li id="menu03" class="nav-out" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/applyJobCenter/">人才中心</a></li>
