...
<div class="nav">
	<ul>
        ...
        <li id="menu06" class="nav-out" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/innovationSalon/">创业沙龙</a></li>
    </ul>
</div>