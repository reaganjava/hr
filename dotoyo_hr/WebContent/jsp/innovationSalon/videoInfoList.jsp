...
<!--以上为头部分-->
<!--中间部分-->
<s:form  id="pageFrom" name="pageFrom" method="POST" action="salonSearchAction!searchVideo.action">
...
<div class="index-login-box">
  <div class="jobs-title"><strong>沙龙视频1</strong></div>
