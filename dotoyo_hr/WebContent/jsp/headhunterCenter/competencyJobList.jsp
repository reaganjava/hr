...
<div class="abstract-title"><h3><s:property value="@com.dotoyo.buildjob.common.util.ClassMasterUtil@getNameInCacheByCode('competencyList',competencyMainType)"/></h3><span></span></div>

<!--职位列表-->
<s:form id="pageFrom" name="pageFrom" method="POST" action="headhunterCenterAction!getMoreCompetencyJobs.action">
...
function showOrderBy(orderBy){
	...
	if($.query.get('competency')!=null&$.query.get('competency'!="")){
		$("#competencyMainType").val($.query.get('competency'));
	}
	
	// 提交表单
	document.pageFrom.action="headhunterCenterAction!getMoreCompetencyJobs.action";
