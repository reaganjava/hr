...
function recoverMenu(){
	...
	$("#menu02").attr("class","nav-out");
}
</script>
<div class="nav">
	<ul>
    	<li id="menu01" class="nav-on" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/">首页</a></li>
        <li id="menu02" class="nav-out" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/headhunterCenter/">猎头中心</a></li>
        ...
        <li id="menu05" class="nav-on" onmouseover="changeMenu(this)" onmouseout="recoverMenu()"><a href="<%=request.getContextPath()%>/certificateCenter/">猎证中心</a></li>
