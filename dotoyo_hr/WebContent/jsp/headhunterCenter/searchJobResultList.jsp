...
<head>
	...
	<title>招聘、求职-职位搜索-大太阳建筑猎头网</title>
                ...
                <div class="abstract-top-left1">
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1">
                            	<img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#industryType', '#searchDown1')" />
                                 <s:textfield id="industryType" name="jobSearchVo.industryName" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract2">
                            	...
                            	<s:textfield id="areaSearch" name="jobSearchVo.areaName" readonly="true"/>
                ...
                <div id="moreCondition" class="abstract-top-left2" style="display:none">
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#specializedType', '#searchDown6')" />
                               <s:textfield id="specializedType" name="jobSearchVo.specializedName" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract2"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#isAdviser', '#searchDown7')" />
                                <s:textfield  id="isAdviser" name="jobSearchVo.isAdviserName" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract16">
                                <s:textfield name="jobSearchVo.jobIssuetDate" value="%{getText('formatDate_yyyy-MM-dd',{jobSearchVo.jobIssuetDate})}" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:1,maxDate:'%y-%M-{%d}'})"/>
                            </li>
                        </ul>
                    </div>
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract4"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#workingLife', '#searchDown9')" />
                                <s:textfield id="workingLife"  name="jobSearchVo.workingLifeName" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract2"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#jobNature', '#searchDown10')" />
                                 <s:textfield  id="jobNature" name="jobSearchVo.jobNatureName" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract4"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#education', '#searchDown11')" />
                                <s:textfield id="education" name="jobSearchVo.educationName" readonly="true"/>
...
<!--分页按钮-->
<s:form id="pageFrom" name="pageFrom" method="POST" action="/search_main/">
...
<div class="abstract-botton">
    ...
    <div class="abstract-botton-right">
        <ul>
            ...
            <li><a href="javascript:showOrderBy(this)"><img onclick="showOrderBy(this)" id="orderByJobIssuetDate" src="<%=request.getContextPath()%>/images/abstract-afbsj2.gif" width="84" height="24" alt="按发布时间"/></a></li>
            <li><a href="javascript:showOrderBy(this)"><img onclick="showOrderBy(this)" id="orderByJobKeyWord" src="<%=request.getContextPath()%>/images/abstract-axgd2.gif" width="68" height="24" alt="按相关度"/></a></li>
        </ul>
    </div>
</div>
	    ...
	    <div class="abstract-text-p" style="display:none">
	    	<div class="abstract-text-p-left">
	        	<p>
	                ...
	                <strong>顾问：</strong><s:if test="isAdviser==1">是</s:if>
		              	<s:elseif test="isAdviser==0">否</s:elseif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                ...
	                <strong>性别：</strong><s:if test='sex=="1"'>男</s:if><s:elseif test='sex=="0"'>女</s:elseif>
		              	<s:elseif test='sex=="2"'>不限</s:elseif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	...
	    	<div class="abstract-text-botton">
		    	...
		    	<a href="javascript:void(0)">
		    		<img src="<%=request.getContextPath()%>/images/abstract-text-botton2.gif" width="75" height="28" alt="企业博站" onclick="return linkBoStation(<s:property value="userId"/>);"/>
		    	</a>
	    	</div>
	    </div>
	</div>
...
<s:hidden id="industryName" name="jobSearchVo.industryName" />
<s:hidden  name="jobSearchVo.industryType" />
...
<s:hidden id="areaName" name="jobSearchVo.areaName" />
<s:hidden  name="jobSearchVo.areaCode" />

<s:hidden id="keyWord" name="jobSearchVo.keyWord" />

<s:hidden id="specializedName" name="jobSearchVo.specializedName" />
<s:hidden  name="jobSearchVo.specializedType" />

<s:hidden id="isAdviserName" name="jobSearchVo.isAdviser" />
<s:hidden  name="jobSearchVo.isAdviserName" />

<s:hidden name="jobSearchVo.jobIssuetDate" />
<input type="hidden" id="jobIssuetDate" value="<s:property value="getText('formatDate_yyyy-MM-dd',{jobSearchVo.jobIssuetDate})"/>"/>


<s:hidden id="workingLifeName" name="jobSearchVo.workingLifeName" />
<s:hidden  name="jobSearchVo.workingLife" />

<s:hidden id="jobNatureName" name="jobSearchVo.jobNatureName" />
<s:hidden  name="jobSearchVo.jobNature" />

<s:hidden id="educationName" name="jobSearchVo.educationName" />
<s:hidden  name="jobSearchVo.education" />
<s:hidden id="searchType" name="jobSearchVo.searchType" />
...
function showOrderBy(orderBy){
	...
	// 提交表单
	document.pageFrom.action="/search_main/";
...
$(function(){
	...
	if(industryName.indexOf(b)>=0||industryName.indexOf(c)>=0){
		industryName="";
	}
	...
	var specializedName=$("#specializedName").val();
	if(specializedName.indexOf(b)>=0||specializedName.indexOf(c)>=0){
		specializedName="";
	}
	var workingLifeName=$("#workingLifeName").val();
	if(workingLifeName.indexOf(b)>=0||workingLifeName.indexOf(c)>=0){
		workingLifeName="";
	}
	var jobNatureName=$("#jobNatureName").val();
	if(jobNatureName.indexOf(b)>=0||jobNatureName.indexOf(c)>=0){
		jobNatureName="";
	}
	var educationName=$("#educationName").val();
	if(educationName.indexOf(b)>=0||educationName.indexOf(c)>=0){
		educationName="";
	}
	...
	if(areaName.indexOf("城区")>=0){
		areaName="";
	}
	var isAdviserName=$("#isAdviserName").val();
	if(isAdviserName=='0'){
		isAdviserName="非顾问";
	}else if(isAdviserName=='1'){
		isAdviserName="顾问";
	}

	var searchCriteriaArray = new Array(industryName,competencyName,provinceName,cityName,
			areaName,$("#keyWord").val(),specializedName,isAdviserName,$("#jobIssuetDate").val(),workingLifeName,jobNatureName,educationName
			,$("#competencyMainType").val());
