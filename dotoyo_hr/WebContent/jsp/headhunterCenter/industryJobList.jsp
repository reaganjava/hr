                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#competency', '#searchDown2')" />
                               <s:textfield id="competency" name="jobSearchVo.competencyName" value="请选择职能" readonly="true"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#specializedType', '#searchDown6')" />
                               <s:textfield id="specializedType" name="jobSearchVo.specializedName" value="请选择专业" readonly="true"/>
...
<div class="abstract-title"><h3>搜索结果</h3><span>当前搜索条件：<strong>
<s:property value="@com.dotoyo.buildjob.common.util.ClassMasterUtil@getNameInCacheByCode('industrysList',industryId)"/></strong></span></div>

<!--职位列表-->
<s:form id="pageFrom" name="pageFrom" method="POST" action="headhunterCenterAction!queryIndustryJob.action">
	...
	<div class="abstract-text-box">
	    ...
	    <div class="abstract-text-p" style="display:none">
	    	...
	    	<div class="abstract-text-botton">
		    	<a href="javascript:appliedJob(<s:property value="id"/>,<s:property value="userId"/>)">
...
<s:hidden id="industryId" name="industryId"/>
...
function showOrderBy(orderBy){
	...
	// 提交表单
	document.pageFrom.action="headhunterCenterAction!queryIndustryJob.action";
