...
<head>
	...
	<title>大太阳建筑猎头-猎头中心-热点城市职位</title>
...
<div class="abstract-title"><h3>搜索结果</h3><span>当前搜索条件：<strong>
	<s:property value="@com.dotoyo.buildjob.common.util.RegionDataUtil@getCityByCode(hotCityCode).name"/>
	</strong></span>
</div>

<!--职位列表-->
<s:form id="pageFrom" name="pageFrom" method="POST" action="headhunterCenterAction!queryHotCityJobs.action">
...
<div class="abstract-botton">
    ...
    <div class="abstract-botton-right">
        <ul>
            ...
            <li><a href="javascript:showOrderByHotCity(this)"><img onclick="showOrderByHotCity(this)" id="orderByJobIssuetDate" src="<%=request.getContextPath()%>/images/abstract-afbsj2.gif" width="84" height="24" alt="按发布时间"/></a></li>
            <li><a href="javascript:showOrderByHotCity(this)"><img onclick="showOrderByHotCity(this)" id="orderByJobKeyWord" src="<%=request.getContextPath()%>/images/abstract-axgd2.gif" width="68" height="24" alt="按相关度"/></a></li>
        </ul>
    </div>
</div>
...
function showOrderByHotCity(orderBy){
	...
	// 提交表单
	document.pageFrom.action="headhunterCenterAction!queryHotCityJobs.action";
