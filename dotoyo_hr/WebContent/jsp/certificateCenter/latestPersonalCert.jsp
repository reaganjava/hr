...
<!--中间部分-->
	    ...
	    <div class="guwen-more">
        	<div class="jobs-title"><strong>最新证书</strong></div>
            <div class="people-text people-text-bg3">
                <ul>
                    <li class="people1">编号</li>
                    <li class="people2">证书类型</li>
                    <li class="people3">证书名称</li>
                    <li class="people4">所在地区</li>
            ...
            <s:iterator value="personalCertSearchResult">
	            <div class="people-text">
	                <ul>
	                    ...
	                    <li class="people3"><a target="_blank" href="certificateAction!viewPersonalCertDetail.action?id=<s:property value="id"/>"><s:property value="cert.getName()"/></a></li>
	...
	<s:form  id="pageFrom" name="pageFrom" method="POST" action="certificateAction!morePersonalCert.action">
		<div class="qx">
