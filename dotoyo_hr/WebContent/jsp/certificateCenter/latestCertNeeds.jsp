...
<!--中间部分-->
	    ...
	    <div class="guwen-more">
        	<div class="jobs-title"><strong>最新需求</strong></div>
    ...
    <s:form  id="pageFrom" name="pageFrom" method="POST" action="certificateAction!moreCertNeeds.action">
       <div class="qx">
