...
<div class="abstract-down" id="showMenuID">
    <div class="abstract-down1" id="searchDown1" onmouseleave="menuHide(this)" style="display:none;">
        <ul>
           <s:iterator value="industrysList">
                <li><a href="javascript:void(0)" id="<s:property value="code" />" onclick="setValue(this,'industryType','hiddenIndustryType')"><s:property value="name"/></a></li>
            </s:iterator>
        </ul>
    </div>
    <div class="abstract-down2" id="searchDown2" onmouseleave="menuHide(this)" style="display:none;">
        <ul>
                ...
                <li><a href="javascript:void(0)" id="<s:property value="code" />" onclick="setValue(this,'competency','hiddenCompetency')"><s:property value="name"/></a></li>
            </s:iterator>
        </ul>
    </div>
    ...
    <div class="abstract-down6" id="searchDown6" onmouseleave="menuHide(this)" style="display:none;">
        <ul>
             <s:iterator value="specializedTypeList">
                <li><a href="javascript:void(0)" id="<s:property value="code" />" onclick="setValue(this,'specializedType','hiddenSpecializedType')"><s:property value="name"/></a></li>
            </s:iterator>
        </ul>
    </div>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract2">
                            	...
                            	<s:textfield id="province" name="jobSearchVo.provinceName" value="省份"/>
                            ...
                            <li class="abstract2">
                            	...
                            	<s:textfield id="citySearch" name="jobSearchVo.cityName" value="城市"/>
                ...
                <div id="moreCondition" class="abstract-top-left2" style="display:none">
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract16">
                                <input name="jobSearchVo.jobIssuetDate" type="text" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:1})"/>
                            </li>
                        </ul>
                    </div>
                    <div class="select-div">
...
<div class="abstract-title"><h3>职位列表</h3></div>

<!--职位列表-->
<s:form id="pageFrom" name="pageFrom" method="POST" action="personalCenterAction!viewNewJobs.action">
	...
	<div class="abstract-text-box">
	    <div class="abstract-text" >
	         <ul>
	             ...
	             <li class="abstract-text2"><s:property value="companyName"/></li>
