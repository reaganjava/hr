       ...
       <s:hidden name="salonMediaDto.mediaType" id="salonMediaDto.mediaType"/>
        ...
        <div class="geren-video">
   	    	 ...
   	    	 <s:iterator value="mediaList">
                 <li>
                 	<a href="salonSearchAction!videoDetail.action?salonMediaDto.id=<s:property value="id"/>&searchFlag=1">
                 	...
                 	<p><input id="arrayIds" name="arrayIds" type="checkbox" value="<s:property value="id"/>"/></p>
                 </li>
             </s:iterator>
             </ul>
		</div>
	...
	<s:form  id="pageFrom" name="pageFrom" method="POST" action="salonManageAction!toMediaListBySalonPage.action">
       ...
       <div class="qx">
       	...
       	<div class="system-botton3">
        	<ul>
                <li class="botton1"><a href="salonManageAction!toUploadMediaPage.action?salonMediaDto.salonId=<s:property value="salonMediaDto.salonId"/>&salonMediaDto.mediaType=<s:property value="salonMediaDto.mediaType"/>&goFrom=1" title="增加视频">增加视频</a></li>
