...
<!--中间部分-->
<s:form name="submitRecommendationForm" id="submitRecommendationForm" method="post" action="personalCenterAction!saveAddRecommendation.action" theme="simple">
...
<div class="jobs-box" align="center">
  <div class="jobs-title"><strong>成为线下推荐对象</strong></div>
    ...
    <div class="jobs-botton">
        ...
        <a href="javascript:window.history.go(-1)"><img src="<%=path%>/images/salon-fh.png" width="83" height="32" alt="返回"/></a>
    </div>
