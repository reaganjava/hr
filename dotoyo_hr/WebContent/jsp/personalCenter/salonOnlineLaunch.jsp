...
<s:include value="left.jsp"/>
   ...
   <div class="content-right">
    	<div class="administrator-title"><strong>线上沙龙发起</strong></div>
        ...
        <div class="inside-tab">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="inside-tab">
              <tr>
                ...
                <td align="left" class="tab-input"><s:textfield maxlength="40" id="subject" name="salonInfoDto.subject" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar]]"/></td>
              </tr>
       	...
       	<div class="system-botton3">
        	<ul>
                ...
                <li class="botton3"><a href="javascript:window.location.href='salonManageAction!myLaunchSalonList.action?salonInfoDto.salonType=1'" title="返回">返回</a></li>
            </ul>
		</div>
