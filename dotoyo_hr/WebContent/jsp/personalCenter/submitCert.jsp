...
<!--中间部分-->
<s:form name="submitCertForm" id="submitCertForm" method="post" action="personalCertManageAction!saveAddPersonalCert.action">
...
<div class="guwen-more">
    ...
    <div class="jobs-select">
      <div class="jobs-select-div">
        <ul>
          ...
          <li class="jobs6">
            <input id="contact" name="personalCertDto.contact" type="text" value="" class="validate[required,custom[filteringSpecialChar4]]" maxlength="20"/>
          </li>
        </ul>
      </div>
      <div class="jobs-select-div">
        <ul>
          ...
          <li class="jobs6">
            <input id="telephone" name="personalCertDto.telephone" type="text" value="" class="validate[custom[telephone]]" maxlength="20"/>
          </li>
        </ul>
      </div>
      <div class="jobs-select-div">
        <ul>
          ...
          <li class="jobs6">
            <input id="cellPhone" maxlength="20" name="personalCertDto.cellPhone" type="text" value="" class="validate[custom[cellPhoneOrEmpty]]"/>
          </li>
        </ul>
      </div>
      <div class="jobs-select-div">
        <ul>
          ...
          <li class="jobs6">
            <input id="email" name="personalCertDto.email" type="text" value="" class="validate[custom[emailOrEmpty]]" maxlength="50"/>
          </li>
        </ul>
      </div>
      <div class="jobs-select-div">
        <ul>
          ...
          <li class="jobs6">
            <input id="fax" maxlength="20" name="personalCertDto.fax" type="text" value="" class="validate[custom[faxOrEmpty]]"/>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="jobs-select">
  	<textarea id="descp" name="personalCertDto.descp" cols="" rows="" class="validate[length[0,200]]"></textarea>
  </div>
