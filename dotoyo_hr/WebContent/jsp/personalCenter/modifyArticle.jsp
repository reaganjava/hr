   ...
   <div class="content-right">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="inside-tab">
              <tr>
                ...
                <td width="90%" align="left" class="tab-input"><img  src="<s:property value="uploadFilePath"/>/<s:property value="salonArticleDto.pictureName"/>" width="120" height="90" /><s:file id="uploadPicFileId" name="uploadPicFile" cssClass="validate[isCheckImg]"/></td>
              </tr>

              <tr>
                <td width="10%" height="40" align="right">视频文件：</td>
                  <s:hidden id="salonArticleDto.videoName" name="salonArticleDto.videoName"/>
                <td width="90%" align="left" class="tab-input"><embed src="<s:property value="uploadFilePath"/>/<s:property value="salonArticleDto.videoName"/>" width="120" height="90" /><s:file id="uploadVideoFileId"  name="uploadVideoFile" cssClass="validate[isCheckVedio]"/></td>
              </tr>
            </table>
            <div class="xiugai">
            	<div class="xiugai-font">内容：</div>
                <div class="xiugai-k">
                <textarea class="ckeditor validate[custom[nullCheckS],length[1,2000]]" cols="80" id="content" name="salonArticleDto.content" rows="10">
