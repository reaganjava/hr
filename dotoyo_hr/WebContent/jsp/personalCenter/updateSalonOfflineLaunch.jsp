...
<s:include value="left.jsp"/>
	...
	<s:form id="addSalonForm1" name="addSalonForm1" method="post" action="salonManageAction!updateSalon.action" enctype ="multipart/form-data">
    <s:hidden name="salonInfoDto.id" id="salonInfoDto.id"/>
    <s:hidden name="salonInfoDto.salonType" id="salonInfoDto.salonType"/>
   <div class="content-right">
    	<div class="administrator-title"><strong>修改线下沙龙发起</strong></div>
        ...
        <div class="inside-tab">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="inside-tab">
              <tr>
                ...
                <td align="left" class="tab-input"><s:textfield size="40" maxlength="40" id="subject" name="salonInfoDto.subject" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar]]"/></td>
              </tr>
              <tr>
               ...
               <tr>
                <td width="29%" height="40" align="right"><strong>举办地点</strong>：</td>
              ...
              <tr>
                ...
                <td align="left" class="tab-input"> <input class='validate[custom[nullCheckS]] Wdate2' id="strStartDate" name="strStartDate" type="text" value="<s:property value="strStartDate"/>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'strEndDate\')}'})"/></td>
              </tr>
              <tr>
                <td width="29%" height="40" align="right"><em>*</em><strong>沙龙结束时间</strong>：</td>
                <td align="left" class="tab-input"><input class='validate[custom[nullCheckS]] Wdate2' id="strEndDate" name="strEndDate" type="text" value="<s:property value="strEndDate"/>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'strStartDate\')}'})"/></td>
              </tr>
              <tr>
                <td width="29%" height="40" align="right"><em></em><strong>主题图片</strong>：</td>
                <td align="left" class="tab-input"><s:file name="uploadPicFile" cssClass="validate[isCheckImg]"/></td>
              </tr>
              <tr>
                <td width="29%" height="40" align="right"><em>*</em><strong>内容介绍</strong>：</td>
                <td align="left" class="tab-input"><s:textarea name="salonInfoDto.content" cssClass="validate[custom[nullCheckS],length[1,2000]]"/></td>
              </tr>
            </table>
  </div>
