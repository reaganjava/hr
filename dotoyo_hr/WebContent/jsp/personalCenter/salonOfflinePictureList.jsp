 ...
 <div class="content-right">
        ...
        <div class="geren-video">
   	    	 ...
   	    	 <s:iterator value="salonList">
                 <li>
                  <a href="salonManageAction!toMediaListBySalonPage.action?salonMediaDto.salonId=<s:property value="id"/>&salonMediaDto.mediaType=<%=ApplicationConstant.MEDIA_TYPE_PICTURE%>"
