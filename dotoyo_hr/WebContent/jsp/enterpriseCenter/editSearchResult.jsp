				...
				<div class="inside-tab">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td align="left" class="tab-input">
								<s:textfield id="metier" name="peopleExcavateVo.metier" maxlength="30"></s:textfield>
							</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td align="left" class="tab-input">
								<s:if test="peopleExcavateVo.recruitingNumber==0">
									<input id="recruitingNumber" name="peopleExcavateVo.recruitingNumber" maxlength="5" class="validate[custom[positiveIntegerOrEmpty]]" type="text" value=""/>
								</s:if>
								<s:else>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<input style="background:#fff url(<%=path %>/javascripts/My97DatePicker/skin/jobs-date2.png) right center no-repeat;"  id="effDate" name="peopleExcavateVo.jobIssuetDate" type="text" value="<s:date name='peopleExcavateVo.jobIssuetDate' format='yyyy-MM-dd'/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d}',maxDate:'#F{$dp.$D(\'expDate\')}'})"/>&nbsp;&nbsp;至&nbsp;&nbsp;
							<input style="background:#fff url(<%=path %>/javascripts/My97DatePicker/skin/jobs-date2.png) right center no-repeat;"  id="expDate" name="peopleExcavateVo.jobExpiryDate" type="text" value="<s:date name='peopleExcavateVo.jobExpiryDate' format='yyyy-MM-dd'/>" onclick="chooseExpDate()"/>
							</td>
				...
				<div class="system-botton3">
					<ul>
						<s:if test='#request.readOnly!="Y"'>
							<li class="botton1"><a href="#" onclick="return submitWithValidate();" title="修改">修改</a></li>
						</s:if>
