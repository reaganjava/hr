...
<s:form name="submitCertNeedsForm" id="submitCertNeedsForm" method="post" action="certNeedsManageAction!saveAddCertNeeds.action">
<input id="submitCertNeedsFormFlag" type="hidden" value="0"/>
  ...
  <div class="jobs-select">
    ...
    <div class="jobs-botton">
        ...
        <a href="javascript:window.location.href='certNeedsManageAction!viewSubmitedCertNeedsList.action'"><img src="<%=request.getContextPath()%>/images/salon-fh.png" width="83" height="32" alt="返回"/></a>
	</div>
