                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#industryType', '#searchDown1')" />
                                 <s:textfield id="industryType" name="jobSearchVo.industryName" value="选择行业类别"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#competency', '#searchDown2')" />
                               <s:textfield id="competency" name="jobSearchVo.competencyName" value="请选择职能" />
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract1"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#specializedType', '#searchDown6')" />
                               <s:textfield id="specializedType" name="jobSearchVo.specializedName" value="请选择专业类型" />
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract4"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#workingLife', '#searchDown9')" />
                                <s:textfield id="workingLife" name="jobSearchVo.workingLifeName"  value="请选择"/>
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract2"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#jobNature', '#searchDown10')" />
                                 <s:textfield  id="jobNature"  name="jobSearchVo.jobNatureName" value="请选择" />
                    ...
                    <div class="select-div">
                        <ul>
                            ...
                            <li class="abstract4"><img src="<%=request.getContextPath()%>/images/search-down.png" width="21" height="22" onclick="menuClick('#education', '#searchDown11')" />
                                <s:textfield id="education" name="jobSearchVo.educationName" value="请选择"/>
...
<!--职位列表-->
<s:form id="pageForm" name="pageFrom" method="POST" action="homePageAction!loadCitySiteHotJobs.action" namespace="/homePage">
...
<div class="abstract-botton">
    ...
    <div class="abstract-botton-right">
        <ul>
            ...
            <li><a href="javascript:void(0)"><img onclick="showOrderByHotCity(this)" id="orderByJobIssuetDate" src="<%=request.getContextPath()%>/images/abstract-afbsj2.gif" width="84" height="24" alt="按发布时间"/></a></li>
            <li><a href="javascript:void(0)"><img onclick="showOrderByHotCity(this)" id="orderByJobKeyWord" src="<%=request.getContextPath()%>/images/abstract-axgd2.gif" width="68" height="24" alt="按相关度"/></a></li>
        </ul>
    </div>
</div>
...
<s:iterator value="citySiteHotJobResultList">
	    ...
	    <div class="abstract-text-p" style="display:none">
	    	...
	    	<div class="abstract-text-botton">
		    	<a href="javascript:void(0)">
		    		<img src="<%=request.getContextPath()%>/images/abstract-text-botton1.gif" width="75" height="28" alt="快速申请" onclick="return appliedcshJob(<s:property value="id"/>,<s:property value="userId"/>);"/>
		    	</a>
		    	<a href="javascript:void(0)">
...
<s:hidden id="orderBy" name="orderBy" />
<s:hidden id="hotCityCode" name="hotCityCode"/>
<s:hidden id="jobSearchVo.id" name="jobSearchVo.id"/>
...
function showOrderByHotCity(orderBy){
	...
	// 提交表单
	document.pageFrom.action="homePageAction!loadCitySiteHotJobs.action";
	document.pageFrom.method='post';
	document.pageFrom.submit();
}

function appliedcshJob(jobId,userId){
...
$(function(){
	...
	var isAdviserName=$("#isAdviser").val();
	if(isAdviserName=='0'){
		isAdviserName="非顾问";
